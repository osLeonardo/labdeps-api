...
namespace PortalTransparenciaDeps.Infrastructure.Migrations
{
    ...
    [Migration("20230623185550_portalTransparenciaDB_migration3")]
    partial class portalTransparenciaDB_migration3
    {
            ...
            modelBuilder.Entity("PortalTransparenciaDeps.Core.Entities.PortalTransparenciaEntities.BolsaFamiliaAggregate.BolsaFamilia", b =>
                {
                    b.HasOne("PortalTransparenciaDeps.Core.Entities.ConsultaAggregate.HistoricoConsulta", "HistoricoConsulta")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bolsa_familia_historico_consulta_id_historico_consulta");
