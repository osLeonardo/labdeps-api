...
namespace PortalTransparenciaDeps.Core.Entities.ConsultaAggregate
{
    public class HistoricoConsulta : BaseEntity<int>, IAggregateRoot
    {
        ...
        public static HistoricoConsulta NewConsulta(UserLogin user, DateOnly dataConsulta, string tipoConsulta, string codigo, DateOnly dataReferencia, string intervalo)
        {
